 ...
 * objects { id, name?, description?, contextWindow?, maxTokens? }. Invalid or
 * duplicate entries are dropped; an empty/absent config falls back to the
 * default Claude Code aliases.
 */
